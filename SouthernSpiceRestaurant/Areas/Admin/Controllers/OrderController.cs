...
namespace SouthernSpiceRestaurant.Areas.Admin.Controllers
{
    ...
    public class OrderController : Controller
    {
        ...
        public IActionResult Details(int orderId)
        {
            OrderVM = new()
            {
                OrderHeader = _unitOfWork.OrderHeader.Get(u => u.Id == orderId, includeDishes: "ApplicationUser"),
                OrderDetail = _unitOfWork.OrderDetail.GetAll(u => u.OrderHeaderId == orderId, includeDishes: "Dish")
            };
        ...
        public IActionResult GetAll(string status)
        {
            ...
            {
                objOrderHeaders = _unitOfWork.OrderHeader.GetAll(includeDishes: "ApplicationUser").ToList();
            }
            else
            {
                ...
                objOrderHeaders = _unitOfWork.OrderHeader.GetAll(u => u.ApplicationUserId == userId, includeDishes: "ApplicationUser");
            }
